...
from .views import index, registrarme, nosotros, productos
from .views import usuarios, bodega, ventas, boleta, ingresar, usuarios
from .views import misdatos, miscompras, salir, carrito, ManOfSteel, BatmanVSuperman, JusticeLeague
...
urlpatterns = [
    ...
    path('ficha/<producto_id>', ManOfSteel, name='ficha'),
    path('ficha/<producto_id>', BatmanVSuperman, name='ficha'),
    path('ficha/<producto_id>', JusticeLeague, name='ficha'),
